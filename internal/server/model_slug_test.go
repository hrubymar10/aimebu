...
func TestCanonicalModelSlug(t *testing.T) {
	cases := []struct {
		...
		{name: "claude opus major only", raw: "claude-opus-5", harness: "claude-code", want: "opus5"},
		{name: "claude sonnet major only", raw: "claude-sonnet-5", harness: "claude-code", want: "sonnet5"},
		{name: "claude fable major only", raw: "claude-fable-5", harness: "claude-code", want: "fable5"},
		...
		{name: "major only bracket suffix", raw: "claude-opus-5 [1m]", harness: "claude-code", want: "opus5"},
		{name: "date suffix", raw: "claude-sonnet-4-6-20260622", harness: "claude-code", want: "sonnet4.6"},
		{name: "major only date suffix", raw: "claude-opus-5-20260601", harness: "claude-code", want: "opus5"},
		{name: "malformed claude id unchanged", raw: "claude-opus-", harness: "claude-code", want: "claude-opus-"},
